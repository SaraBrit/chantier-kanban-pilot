...
export const ProjectsList = ({ projects, onProjectSelect }: ProjectsListProps) => {
  ...
  return (
    <div 
      ...
      style={{ backgroundImage: 'url(/lovable-uploads/9245aeac-465f-4d15-a87e-f871c3b78a39.png)' }}
    >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project) => (
              <Card 
                key={project.id} 
                className="cursor-pointer hover:shadow-lg transition-all duration-300 transform hover:scale-105 bg-white/95 backdrop-blur-sm"
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    <span>{project.monthlyBilling.toLocaleString()} €/mois</span>
                  </div>
